...
\begin{document}
	...
	\begin{resume}
		...
		%Obtener una posición en el campo de la Ciencia de Datos y Análisis Estadístico de experimentos.\\ Aplicaciones: Genómica, Inmunología y Epidemiología siguiendo principios de Ciencia Reproducible.\\ 
...
\begin{tabular}{ l l }
	...
	{\bf Bioinformática}: & Aplicaciones en filogenética, ensamble de genomas y genómica estructural.\\	%biología molecular \textit{in silico}
\end{tabular}
