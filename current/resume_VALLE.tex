...
Systems Biology. Biostatistics as toolkit. Data Science education. Healthy work environments.\\ %tabular data
...
\section{\sc Publications (n=7)}

{\bf Peer-reviewed (n=5)}\\
...
\begin{tabular}{ l l}
	{\bf Statistical programming}: & R (work-in-progress: %work-in-progress 
...
\section{\sc Teaching experience at university}
...
{\bf Epidemiology}: Teacher Assistant. Master of Science in Epidemiological Research \href{https://www.posgradoupch.pe/programa/maestria-en-ciencias-en-investigacion-epidemiologica/#1479997658201-821008b1-6b83}{\ExternalLink}. \hfill {2019}\\In charge of practical sessions, monthly reviews, and test correction. \textit{48 grad students}. \\[4pt] %% Graph theory to model Topology and Automata Networks for Dynamics of GRN %% Modeling of Networks
...
{\bf Biomathematics}: [Gene Regulatory Networks: Topology and Dynamics] \href{https://drive.google.com/file/d/1S_cg8BC8iYXqJKb8RFR6iU8ophhMnGFx/view?usp=sharing}{\ExternalLink}. \textit{3 hours}. \hfill {2015-18}\\ Applications from Graph Theory and Finite Automata. \textit{10 undergrad students}. \\[4pt] %% Graph theory to model Topology and Automata Networks for Dynamics of GRN %% Modeling of Networks
{\bf Horizontal Gene Transfer}: [On \#tardigate and HGT bioinformatics] \href{https://drive.google.com/file/d/1UfmbnVV8pmrAZD9S93G-sTT2d-bWDn6r/view?usp=sharing}{\ExternalLink}. \textit{2 hours}. \hfill {2016}\\ 
...
{\bf Outbrake Analytics and Modelling for Public Health \href{https://www.ins.gov.co/modelamiento/modelamiento.html}{\ExternalLink} \href{https://github.com/avallecam/recon_r}{\includegraphics[scale=.004]{../figure/gh_logo.png}} }\hfill {Jun 2019}\\
-One week on dynamic modeling in response to outbrakes and interventions.\\
-Imperial College London, UK (ICL), Pontificia Universidad Javeriana, Bogotá - Colombia.\\
...
-Two weeks on data management, open science, machine learning and infrastructure.\\
...
%\end{list2}
{\bf [Minicourse on Spatio-Temporal Models in Epidemiology] \href{http://www.cipefa2017.uni.edu.pe/}{\ExternalLink} }\hfill {Oct 2017}\\
-I International Conference of Stochastic Processes, Random phenomena and Applications.\\
-Theory and practice of areal data, point pattern analysis and geostatistics.\\
...
%\end{list2}
{\bf Working with Parasite Database Resources \href{https://coursesandconferences.wellcomegenomecampus.org/our-events/working-with-parasite-database-resources-2016-montevideo-uruguay-2016/}{\ExternalLink}}\hfill {Oct 2016}\\
-One week on genomic, proteomic, metabolomic applications of \texttt{eupathdb.org}.\\
...
%\end{list2}
{\bf V Southern-Summer School on Mathematical Biology \href{http://ecologia.ib.usp.br/ssmb/doku.php}{\ExternalLink}}\hfill {Jan 2016}\\
-One week on population dynamics modeling in ecology and epidemiology.\\% \textit{Experience:}
