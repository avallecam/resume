...
\begin{tabular}{ l l}
	{\bf Statistical programming}: & R (developer of work-in-progress packages like %work-in-progress 
	\href{https://avallecam.github.io/serosurvey/}{\texttt{serosurvey}}%, 
	%\href{https://github.com/avallecam/elixr}{\texttt{elixr}}
	).\\ 
...
\section{\sc Conference participant}
...
{\bf [Gene Regulatory Networks: Topology and Dynamics]} \href{https://bit.ly/biomath2017_}{\ExternalLink} \textit{3 hours} \hfill {2015-18}\\ Applications from Graph Theory and Finite Automata. \textit{10 undergrad students}. \\[4pt] %% Graph theory to model Topology and Automata Networks for Dynamics of GRN %% Modeling of Networks
...
Review of the controversy around the first tardigrade genome. \textit{5 undergrad students}. %\\
