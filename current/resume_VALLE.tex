...
Quantitative biology and interdisciplinary research. Statistical data analysis following \\Reproducible Science principles and Network biology for dynamic systems modeling.\\%Interdisciplinary . 
...
{\bf Biomathematics}: {\em Gene Regulatory Networks}. \hfill {December 2015/16}\\ GRN topology and dynamics using Graph Theory and Finite Automata. \\[4pt] %% Graph theory to model Topology and Automata Networks for Dynamics of GRN %% Modeling of Networks
