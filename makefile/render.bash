...
cp current/cover_VALLE.pdf release-pdf/CoverLetter_ValleCampos-Andree.pdf
cp current/resume_VALLE.pdf release-pdf/CV_ValleCampos-Andree-ENG.pdf
cp spanish/resume_VALLE-ESP.pdf release-pdf/CV_ValleCampos-Andree-ESP.pdf
mupdf release-pdf/CV_ValleCampos-Andree.pdf
mupdf release-pdf/CoverLetter_ValleCampos-Andree.pdf
